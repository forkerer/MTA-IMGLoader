...
function BinaryConverter:FromHalf(str)
	if str == self.halfNaNbig or str == self.halfNaNlittle then
		return NaN
...
function BinaryConverter:FromFloat(str)
	if str == self.floatNaNbig or str == self.floatNaNlittle then
		return NaN
...
function BinaryConverter:FromDouble(str)
	if str == self.doubleNaNbig or str == self.doubleNaNlittle then
		return NaN
